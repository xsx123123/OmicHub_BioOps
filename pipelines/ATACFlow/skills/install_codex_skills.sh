#!/bin/bash
# ATACFlow Skills Installer for Codex
# Installs ATACFlow skills to .codex/skills directory
...
TARGET_DIR="$CODEX_SKILLS_DIR/ATACFlow"

echo "=========================================="
echo "ATACFlow Skills Installer for Codex"
echo "=========================================="
