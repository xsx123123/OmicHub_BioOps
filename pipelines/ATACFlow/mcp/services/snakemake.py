#!/usr/bin/env python3
"""
Snakemake execution services for ATACFlow MCP
"""
...
from core.config import ATACFLOW_ROOT, MCP_PATHS
        ...
        try:
            with open(config_file, "r", encoding="utf-8") as f:
                ...
                if config_dict.get("only_qc", False):
                    ...
                    if config_dict.get("call_variant") or config_dict.get(""):
...
✅ 设置 `user_confirmed=True` 将立即开始ATACFlow分析
"""
...
async def run_atacflow(
    ...
    env_name = MCP_PATHS.get("default_env", "atacflow")
