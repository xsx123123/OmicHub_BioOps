#!/usr/bin/env python3
"""
Project management services for ATACFlow MCP
"""
...
def generate_config_file(config: ProjectConfig, output_path: str) -> str:
    ...
    try:
        ...
        header = f"""# ATACFlow Analysis Configuration
# Generated by ATACFlow MCP Server
...
def get_project_structure() -> Dict[str, Any]:
    ...
    return {
        ...
        "description": "Standard project structure for ATACFlow analysis.",
