#!/usr/bin/env python3
"""
Pydantic data models for ATACFlow MCP
"""
...
class ProjectConfig(BaseModel):
    """Complete project configuration model matching ATACFlow specs"""
    ...
    deg: bool = Field(
        default=True, description="Enable DESeq2 differential peak analysis"
    )
    call_variant: bool = Field(
        default=False, description="Enable variant calling (if applicable)"
    )
