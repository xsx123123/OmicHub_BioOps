...
### P0-G ✅ 通用化基础：动态流程/角色/Agent 发现（R6，2026-08-11 已完成）
...
✅ 新增/停用 Agent 或 flow 无需重启运行时可识别。（2026-08-11）
✅ `ROLE_AGENT_MAP` / `ALLOWED_CONSULTATION_AGENTS` / `_AGENT_PROFILES` 三处硬编码消除。（2026-08-11）
