...
main <- function(opt) {
  ...
  ## The function library now manages its own local_logger (no global binding).
  # Reclustering starts below; logging is handled internally by SingleSampleSubClusterRereduction.
