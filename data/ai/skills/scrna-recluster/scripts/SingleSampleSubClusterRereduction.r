...
######################
AutoSettingPcCutoff <- function(data,plot_name,save_dir,logger){
  require(ggplot2)
  require(patchwork)
  # data <- sce
  # auto set pc cutoff
