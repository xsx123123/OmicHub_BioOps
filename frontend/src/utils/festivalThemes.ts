...
export const FESTIVAL_THEMES: FestivalTheme[] = [
  {
    ...
    poemAuthor: '王安石《元日》',
    message: '在这辞旧迎新的时刻，愿星光为你指引前路。CygnusX 送你 {amount} 额度，开启新一年的探索之旅！',
  ...
  },
  {
    ...
    poemAuthor: '韩愈《春雪》',
    message: '新的一年，新的宇宙。每一个新的开始，都像是一次超新星爆发。CygnusX 送你 {amount} 额度，新年快乐！',
  ...
  },
  {
    ...
    poemAuthor: '杜甫《小至》',
    message: '冬至大如年。在最长的黑夜里，愿 CygnusX 的一点点温暖能照亮你的路。送你 {amount} 额度！',
  ...
  },
  {
    ...
    message: '从第一行代码到今天，CygnusX 已经陪伴大家走过了一整年。感谢每一个深夜还在分析数据的你。送你 {amount} 额度！',
