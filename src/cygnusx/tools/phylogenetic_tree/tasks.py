...
任务命名：cygnusx.tools.phylogenetic_tree.tasks.build_tree
...
@shared_task(  # type: ignore[untyped-decorator]
    bind=True,
    name="cygnusx.tools.phylogenetic_tree.tasks.build_tree",
    time_limit=3600 * 2,
...
def build_phylogenetic_tree(self: Any, task_input: dict[str, Any]) -> dict[str, Any]:
    ...
    from cygnusx.tools.phylogenetic_tree.core import build_tree
