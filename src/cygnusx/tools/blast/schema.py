...
class BlastDatabaseDTO(CygnusXBaseSchema):
    """BLAST 数据库元数据 DTO。"""
...
class BlastDatabaseCreateRequest(CygnusXBaseSchema):
    """管理员创建数据库请求。"""
...
class BlastDatabaseUploadInitResponse(CygnusXBaseSchema):
    """数据库分片上传会话。"""
...
class BlastHspDTO(CygnusXBaseSchema):
    """单个 HSP 摘要信息。"""
...
class BlastHspDetailDTO(CygnusXBaseSchema):
    """单个 HSP 完整信息（含序列对齐）。"""
...
class BlastHitDTO(CygnusXBaseSchema):
    """单个 BLAST 命中结果。"""
...
class BlastStatisticsDTO(CygnusXBaseSchema):
    """BLAST 结果统计摘要。"""
...
class BlastResultDTO(CygnusXBaseSchema):
    """BLAST 查询结果响应。"""
...
class BlastTaskResponse(CygnusXBaseSchema):
    """任务状态/进度响应。"""
...
class BlastSubmitRequest(CygnusXBaseSchema):
    """提交 BLAST 查询任务请求。"""
...
class BlastBuildStatusResponse(CygnusXBaseSchema):
    """数据库构建状态响应。"""
...
class BlastMethodsResponse(CygnusXBaseSchema):
...
class BlastTaskListItemDTO(CygnusXBaseSchema):
    """任务列表单项。"""
...
class BlastTaskListResponse(CygnusXBaseSchema):
    """任务列表分页响应。"""
...
class BlastAdminTaskListResponse(CygnusXBaseSchema):
    """管理员任务列表分页响应。"""
