...
任务命名：
- cygnusx.tools.blast.tasks.run_blast_search
- cygnusx.tools.blast.tasks.build_blast_database
...
from cygnusx.tools.blast.cache import build_result_cache_key, set_cached_result
from cygnusx.tools.blast.core import build_blast_database, run_blast_search
from cygnusx.tools.blast.events import publish_blast_event, publish_blast_event_sync
...
@shared_task(  # type: ignore[untyped-decorator]
    bind=True,
    name="cygnusx.tools.blast.tasks.run_blast_search",
    time_limit=3600,
...
@shared_task(  # type: ignore[untyped-decorator]
    bind=True,
    name="cygnusx.tools.blast.tasks.build_blast_database",
    time_limit=3600 * 2,
