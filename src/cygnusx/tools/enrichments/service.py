...
from cygnusx.tools.enrichments.config import (
    EnrichmentConfigManager,
    SpeciesConfig,
    config_manager,
)
from cygnusx.tools.enrichments.schema import (
...
class EnrichmentService:
    ...
    async def submit(
        ...
        try:
            from cygnusx.tools.enrichments.tasks import run_enrichment_task
