...
from cygnusx.tools.terminal.config import TerminalImage, get_terminal_config
...
class TerminalDockerManager:
    ...
    async def create_container(
        ...
        system_mounts = {
            "workspace": "/home/cygnusx/workspace",
            "raw_data": "/home/cygnusx/raw_data",
            "temp": "/home/cygnusx/temp",
        }
        ...
        container_name = f"cygnusx-term-{user_id[:8]}-{session_id}"
        ...
        def _run() -> str:
            container = client.containers.run(
                ...
                tmpfs={
                    ...
                    "/home/cygnusx/.cache": "rw,noexec,nosuid,size=50m",
                },
                volumes=volumes,
                ports={"7681/tcp": port},
                ...
                working_dir="/home/cygnusx/workspace",
                name=container_name,
                labels={
                    "app": "cygnusx-terminal",
                    "user_id": user_id,
                    "session_id": session_id,
                    "image_id": image.id,
                },
