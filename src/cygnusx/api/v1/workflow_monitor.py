...
from cygnusx.application.services.workflow_monitor_service import WorkflowMonitorService
from cygnusx.application.services.workflow_monitor_template_service import (
...
from cygnusx.infrastructure.cache.workflow_monitor_pubsub import (
    subscribe_global,
    subscribe_task,
    subscribe_user,
)
...
@router.post("/events", summary="CygnusX 原生流程监控事件摄取")
async def ingest_event(
    ...
    x_cygnusx_timestamp: Annotated[str | None, Header(alias="X-CygnusX-Timestamp")] = None,
    x_cygnusx_nonce: Annotated[str | None, Header(alias="X-CygnusX-Nonce")] = None,
    x_cygnusx_signature: Annotated[str | None, Header(alias="X-CygnusX-Signature")] = None,
) -> dict:
