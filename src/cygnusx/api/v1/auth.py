...
from cygnusx.application.schemas.auth import (
    LoginResponse,
    RefreshTokenRequest,
    TokenResponse,
...
from cygnusx.application.schemas.user import UserResponse
from cygnusx.application.services import AuthService
from cygnusx.application.services.auth_service import LoginTwoFactorRequired
from cygnusx.application.services.totp_service import MfaService
from cygnusx.core.config import get_settings
from cygnusx.core.exceptions import AuthenticationError, AuthorizationError, ConflictError
from cygnusx.core.security import (
    create_access_token,
...
from cygnusx.middleware.login_rate_limit import LoginRateLimitDep
...
async def setup_first_admin(
    ...
    from cygnusx.application.services.auth_service import create_welcome_notification
