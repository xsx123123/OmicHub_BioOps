...
from cygnusx.api.v1.admin import admin_cookies
from cygnusx.api.v1.admin import agents as admin_agents
from cygnusx.api.v1.admin import agentteams_bridge as admin_agentteams_bridge
from cygnusx.api.v1.admin import ai_metrics as admin_ai_metrics
from cygnusx.api.v1.admin import ai_providers as admin_ai_providers
from cygnusx.api.v1.admin import assistants as admin_assistants
from cygnusx.api.v1.admin import database as admin_database
from cygnusx.api.v1.admin import festival as admin_festival
from cygnusx.api.v1.admin import knowledge_bases as admin_knowledge_bases
from cygnusx.api.v1.admin import platform_config as admin_platform_config
from cygnusx.api.v1.admin import search_providers as admin_search_providers
from cygnusx.api.v1.admin import session_logs as admin_session_logs
from cygnusx.api.v1.admin import skills as admin_skills
from cygnusx.api.v1.admin import stats as admin_stats
from cygnusx.api.v1.admin import storage as admin_storage
from cygnusx.api.v1.admin import terminals as admin_terminals
from cygnusx.api.v1.admin import users as admin_users
from cygnusx.api.v1.admin import workspace_archive as admin_workspace_archive
from cygnusx.reference_genomes.api import router as reference_genomes_router
from cygnusx.tools import register_tool_routers
...
api_router.include_router(
    admin_workspace_archive.router,
    prefix="/admin/workspace-archive",
    tags=["Admin-WorkspaceArchive"],
)
...
api_router.include_router(
    admin_database.router, prefix="/admin/database", tags=["Admin-Database"]
)
api_router.include_router(
...
# 生信工具箱：自动发现 cygnusx.tools.<工具>.api 并挂载（每个工具自声明 prefix/tags）
# 新增工具无需改本文件 —— 在 src/cygnusx/tools/<工具名>/api.py 声明 router/prefix/tags 即可。
