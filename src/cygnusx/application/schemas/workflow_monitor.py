...
class MonitorTemplateListItem(CygnusXBaseSchema):
    id: str
    name: str
    version: str = "1.0.0"
    scope: str = "user"
...
class MonitorTemplateListResponse(CygnusXBaseSchema):
    items: list[MonitorTemplateListItem]
    total: int


class MonitorTemplateResponse(CygnusXBaseSchema):
    id: str
    name: str
    version: str = "1.0.0"
    description: str = ""
...
class WorkflowMonitorSummary(CygnusXBaseSchema):
    running_count: int = 0
    failed_today: int = 0
...
class WorkflowTaskSnapshot(CygnusXBaseSchema):
    id: str
    name: str
    flow_id: str
    user_id: str
...
class WorkflowEvent(CygnusXBaseSchema):
    schema_version: str = "cygnusx.workflow_event.v1"
    task_id: str
...
class WorkflowOverviewResponse(CygnusXBaseSchema):
...
class WorkflowEventListResponse(CygnusXBaseSchema):
    items: list[WorkflowEvent]
    total: int


class WorkflowMonitorWsMessage(CygnusXBaseSchema):
