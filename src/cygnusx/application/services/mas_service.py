...
from cygnusx.domain.mas.models import A2AEvent, A2AEventType, AgentRecipient, AgentSender
from cygnusx.domain.mas.workspace import WorkspaceLayout
from cygnusx.infrastructure.database.models.mas import MASArtifactModel, MASRunModel
...
class MASService:
    ...
    async def resolve_approval(
        ...
        if approval.kind == "quality_gate_failed":
            from cygnusx.domain.mas.quality_gate import QCOverrideRequest
