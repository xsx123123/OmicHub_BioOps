...
from cygnusx.application.schemas.file import (
    DataFileDTO,
...
from cygnusx.domain.file.entities import DataFile, Directory, Sample
from cygnusx.domain.file.value_objects import FileSource, FileType, OwnerScope
from cygnusx.domain.team.value_objects import TeamRole
from cygnusx.infrastructure.database.repositories import (
...
class FileService:
    ...
    def _upload_svc(self):
        ...
        if not hasattr(self, "__upload_svc"):
            from cygnusx.application.services.upload_service import UploadService
    ...
    def _dir_svc(self):
        ...
        if not hasattr(self, "_FileService__dir_svc"):
            from cygnusx.application.services.directory_service import DirectoryService
