...
from cygnusx.domain.flow.entities import ConditionRule
from cygnusx.domain.flow.value_objects import ConditionOperatorEnum, ParameterTypeEnum

if TYPE_CHECKING:
    from cygnusx.domain.flow.entities import Parameter
