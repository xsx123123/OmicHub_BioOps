...
from omichub.tools.deg.service import FLOW_ID, RESULTS_SUBDIR, TOP_GENES_PER_CONTRAST
...
@shared_task(  # type: ignore[untyped-decorator]
    bind=True,
    name="omichub.tools.deg.tasks.run_deg_task",
    queue="analysis",
    time_limit=7800,
...
async def _run_deg(task_id: str) -> dict[str, Any]:
    ...
    async with factory() as db:
        ...
        try:
            ...
            container_name = f"omichub-deg-{task_id[:8]}"
