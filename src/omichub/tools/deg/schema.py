...
class DegDefaultsDTO(OmicsHubBaseSchema):
...
class DegContrastStatDTO(OmicsHubBaseSchema):
...
class DegGeneRowDTO(OmicsHubBaseSchema):
...
class DegContrastResultDTO(OmicsHubBaseSchema):
...
class DegResultDTO(OmicsHubBaseSchema):
    """完成后的 DEG 分析结果。"""
...
class DegTaskDTO(OmicsHubBaseSchema):
...
class DegTaskListResponse(OmicsHubBaseSchema):
