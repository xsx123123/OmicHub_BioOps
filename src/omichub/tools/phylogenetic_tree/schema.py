...
class TreeStatisticsDTO(OmicsHubBaseSchema):
...
class PhyloUploadResponse(OmicsHubBaseSchema):
    """上传序列/Newick 文件后返回。"""
...
class PhyloSubmitRequest(OmicsHubBaseSchema):
    """提交树构建任务参数。"""
...
class PhyloTaskResponse(OmicsHubBaseSchema):
    """任务状态/进度响应。"""
...
class PhyloResultDTO(OmicsHubBaseSchema):
    """任务成功后的结果摘要。"""
...
class PhyloDownloadResponse(OmicsHubBaseSchema):
...
class PhyloMethodOptionDTO(OmicsHubBaseSchema):
    """下拉选项。"""
...
class PhyloMethodsResponse(OmicsHubBaseSchema):
...
class PhyloValidateRequest(OmicsHubBaseSchema):
    """参数合法性预校验请求。"""
...
class PhyloValidateResponse(OmicsHubBaseSchema):
    """参数合法性预校验响应。"""
