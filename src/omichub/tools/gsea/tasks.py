...
from omichub.tools.gsea.runner import GseaDockerRunner, GseaRunParams


@shared_task(
    bind=True, name="omichub.tools.gsea.tasks.run_gsea_task", queue="analysis", time_limit=900
)
