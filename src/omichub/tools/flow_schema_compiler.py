...
class FlowToolSchemaCompiler:
    ...
    def compile_prepare_tool(self, flow: FlowConfig) -> dict[str, Any]:
        ...
        生成名为 omichub_prepare_{tool_slug}_submission 的 tool schema。
        """
        ...
        tool_name = f"omichub_prepare_{tool_slug}_submission"
    ...
    def compile_status_tool(self) -> dict[str, Any]:
        """编译任务状态查询工具 schema。"""
        return {
            "name": "omichub_get_analysis_task_status",
    ...
    def compile_summary_tool(self) -> dict[str, Any]:
        """编译任务摘要查询工具 schema。"""
        return {
            "name": "omichub_get_analysis_task_summary",
