...
from omichub.tools.enrichments.config import config_manager
from omichub.tools.enrichments.runner import EnrichmentDockerRunner, EnrichmentRunParams
from omichub.tools.enrichments.schema import EnrichmentResultDTO
...
@shared_task(  # type: ignore[untyped-decorator]
    bind=True,
    name="omichub.tools.enrichments.tasks.run_enrichment_task",
    queue="analysis",
    time_limit=900,
    soft_time_limit=840,
)
...
async def _run_enrichment(task_id: str) -> dict[str, Any]:
    ...
    async with factory() as db:
        ...
        try:
            ...
            container_name = f"omichub-enrich-{task_id[:8]}"
