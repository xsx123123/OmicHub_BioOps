...
_meter = get_meter("omichub.database")
_pool_checked_out = _meter.create_up_down_counter(
    "omichub.database.pool.checked_out",
    unit="{connection}",
