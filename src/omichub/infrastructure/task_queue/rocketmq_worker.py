"""RocketMQ consumer for OmicHub tasks.

Usage:
    python -m omichub.infrastructure.task_queue.rocketmq_worker --queues analysis,phylo_tree
"""
...
from omichub.infrastructure.task_queue.rocketmq import (
    decode_envelope,
    execute_task,
    publish_task,
    topic_for,
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run OmicHub RocketMQ task consumer")
