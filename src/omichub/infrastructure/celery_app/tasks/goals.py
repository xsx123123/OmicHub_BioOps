...
@shared_task(name="omichub.infrastructure.celery_app.tasks.goals.run_goal_step")
...
async def _run_goal_step(goal_id: str, cause: str) -> dict[str, str | bool]:
    from omichub.application.services.goal_execution_engine import GoalExecutionEngine
...
@shared_task(name="omichub.infrastructure.celery_app.tasks.goals.recover_expired_goal_leases")
