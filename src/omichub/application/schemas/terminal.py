...
class TerminalResourceDTO(OmicsHubBaseSchema):
    """终端资源配额"""
...
class TerminalImageResourceDTO(OmicsHubBaseSchema):
    """镜像默认资源限制"""
...
class TerminalRuntimeResourceDTO(OmicsHubBaseSchema):
    """终端运行时资源配置"""
...
class TerminalRuntimeConfigDTO(OmicsHubBaseSchema):
    """终端运行时配置（返回前端用）"""
...
class TerminalImageEnvDTO(OmicsHubBaseSchema):
    """镜像环境变量"""
...
class TerminalImageDTO(OmicsHubBaseSchema):
    """单个沙盒终端镜像定义（返回前端用）"""
...
class TerminalImagesConfigDTO(OmicsHubBaseSchema):
    """镜像配置根模型"""
...
class TerminalSessionDTO(OmicsHubBaseSchema):
    """终端会话"""
...
class CreateTerminalDTO(OmicsHubBaseSchema):
    """创建终端会话"""
...
class AdminTerminalSessionDTO(OmicsHubBaseSchema):
