from omichub.infrastructure.mcp.presets import PRESET_SERVERS, _build_omichub_tools_preset


def test_omichub_tools_preset_has_unique_tool_names() -> None:
...
def test_all_builtin_presets_have_unique_tools_and_handlers() -> None:
    for preset in [*PRESET_SERVERS, _build_omichub_tools_preset()]:
        names = [tool["name"] for tool in preset["tools"]]
