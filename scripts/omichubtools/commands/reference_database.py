"""Build OmicHub reference database assets offline.
...
and registration snippets. The OmicHub service should only read the generated
...
def record_metadata(conn: sqlite3.Connection, args: argparse.Namespace) -> None:
    items = {
        ...
        "builder": "omichubtools refdb build",
    }
    conn.executemany(
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Offline builder for OmicHub FA/GFF/GO/KO/KEGG reference database assets.",
