#!/usr/bin/env python3
"""Logo display helpers for omichubtools.

The structure mirrors the gpse ``LogoDisplay`` utility while using OmicHub
...
class LogoDisplay:
    ...
    def __init__(
        self,
        version: str = "0.1.0",
        app_name: str = "omichubtools",
        description: str = "OmicHub offline maintenance toolkit",
        url: str = "",
...
def config2logo(config: dict | None = None) -> None:
    ...
    show_logo(
        ...
        app_name=sw.get("app_name", "omichubtools"),
