#!/usr/bin/env python3
"""Loguru/Rich logging helpers for omichubtools."""
...
def _ensure_loguru() -> None:
    if not _LOGURU_AVAILABLE:
        raise ImportError("loguru is required for omichubtools logging")
...
def setup_tool_logging(
    log_dir: str | Path = "logs/omichubtools",
    log_file_prefix: str = "omichubtools",
    log_level: str = "INFO",
    style: str = "default",
):
