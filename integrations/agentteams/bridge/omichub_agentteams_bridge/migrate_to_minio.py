...
用法：
    ...
    python -m omichub_agentteams_bridge.migrate_to_minio \
        --case-store-path /var/lib/omichub-agentteams-bridge/cases.json \
        --audit-log-path /var/lib/omichub-agentteams-bridge/audit.jsonl
