...
PROXY_COMPOSE = ROOT / "deploy/agentteams/docker-compose.omichub-proxy.yml"
...
def test_proxy_networks_are_external_and_do_not_create_replacements() -> None:
    ...
    for network in ("app_net", "data_net", "omichub_net", "omichub-sandbox-net"):
    ...
    assert networks["omichub_bridge_gateway"]["external"] is True
